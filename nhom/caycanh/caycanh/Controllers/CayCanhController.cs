...
namespace caycanh.Controllers
{
    public class CayCanhController : Controller
    {
        ...
        {
            List<CayCanh> cayCanhs = db.CayCanhs.ToList();
        ...
        {
            List<LoaiCay> loaiCayList = db.LoaiCays.ToList();
        ...
        {
            CayCanh cayCanh = db.CayCanhs.FirstOrDefault(l => l.MaCay == id);
